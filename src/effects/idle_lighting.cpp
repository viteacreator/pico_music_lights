...
constexpr uint32_t kLinearSources =
    source_bit(EffectSource::left) | source_bit(EffectSource::right) |
    source_bit(EffectSource::aux) | source_bit(EffectSource::mono);
...
constexpr uint32_t kBasic =
    effect_parameter_enabled | effect_parameter_colours | effect_parameter_gain;
...
constexpr uint32_t kSpectrum =
    kBasic | effect_parameter_source | effect_parameter_direction |
    effect_parameter_palette | effect_parameter_response |
    effect_parameter_geometry;
...
constexpr uint32_t kGyverRunningFrequencies =
    kBasic | effect_parameter_source | effect_parameter_direction |
    effect_parameter_gyver_adaptive | effect_parameter_running_policy;
constexpr uint32_t kGyverVuGradient =
    kBasic | effect_parameter_source | effect_parameter_direction |
    effect_parameter_palette | effect_parameter_response |
    effect_parameter_gyver_adaptive | effect_parameter_gyver_vu_gate;
constexpr uint32_t kGyverVuRainbow =
    kBasic | effect_parameter_source | effect_parameter_direction |
    effect_parameter_response | effect_parameter_animation |
    effect_parameter_gyver_adaptive | effect_parameter_gyver_vu_gate;
...
constexpr uint32_t kRunningRainbow =
    effect_parameter_enabled | effect_parameter_gain |
    effect_parameter_direction | effect_parameter_animation;
constexpr uint32_t kGyverSpectrum =
    kBasic | effect_parameter_source | effect_parameter_direction |
    effect_parameter_palette | effect_parameter_response |
    effect_parameter_gyver_adaptive | effect_parameter_spectrum_gate;

constexpr std::array<ParameterDescriptor, kEffectParameterDescriptorCount>
    kParameterDescriptors{{
        {"enabled", "Enabled", ParameterValueType::boolean, "boolean", 0u, 1u,
         1u, 0u},
        {"source", "Audio Source", ParameterValueType::enumeration, "enum", 0u,
         12u, 1u, 0u,
         "none,left,right,aux,mono,bass,low,mid,high,stereo_left_right,"
         "spectrum_32,macro_bands"},
        {"direction", "Direction", ParameterValueType::boolean, "boolean", 0u,
         1u, 1u, 0u},
        {"colours", "Colours", ParameterValueType::colour, "RGBW", 0u, 255u, 1u,
         0u},
        {"palette", "Palette", ParameterValueType::colour, "RGBW", 0u, 255u, 1u,
         0u},
        {"visual_gain", "Visual Gain", ParameterValueType::unsigned_integer,
         "Q8", 0u, 1024u, 1u, 256u},
        {"response", "Attack / Release", ParameterValueType::unsigned_integer,
         "ms", 0u, 5000u, 1u, 0u},
        {"animation", "Animation", ParameterValueType::unsigned_integer, "Q8",
         0u, 4096u, 1u, 256u},
        {"geometry", "Geometry", ParameterValueType::unsigned_integer, "count",
         1u, 32u, 1u, 16u},
        {"strobe", "Strobe", ParameterValueType::unsigned_integer,
         "Hz / percent", 0u, 100u, 1u, 8u},
        {"gyver_adaptive", "Gyver Adaptive",
         ParameterValueType::unsigned_integer, "ms / percent", 0u, 5000u, 1u,
         0u},
        {"static_white_boost", "White Boost",
         ParameterValueType::unsigned_integer, "percent", 0u, 200u, 1u, 100u},
        {"frequency_selection", "Frequency Selection",
         ParameterValueType::enumeration, "enum", 0u, 3u, 1u, 0u,
         "three_frequencies,low,mid,high"},
        {"comet", "Comet Tail / Threshold",
         ParameterValueType::unsigned_integer, "percent / level", 0u, 65535u,
         1u, 20u},
        {"gyver_vu_gate", "Gyver VU Gate", ParameterValueType::unsigned_integer,
         "raw ADC", 0u, 2047u, 1u, 32u},
        {"spectrum_gate", "Spectrum Floor / Peak",
         ParameterValueType::unsigned_integer, "level", 0u, 65535u, 1u, 256u},
        {"running_policy", "Running Policy", ParameterValueType::enumeration,
         "enum", 0u, 1u, 1u, 0u, "gyver_priority,strongest_event"},
        {"macro_mapping", "Macro Mapping", ParameterValueType::enumeration,
         "enum", 0u, 1u, 1u, 0u, "low_mid_high,bass_mid_high"},
        {"full_strip_policy", "Full Strip Policy",
         ParameterValueType::enumeration, "enum", 0u, 1u, 1u, 0u,
         "gyver_priority,strongest_event"},
    }};

constexpr std::array<ParameterDescriptor, kIdleParameterDescriptorCount>
    kIdleParameterDescriptors{{
        {"idle_enabled", "Idle Enabled", ParameterValueType::boolean, "boolean",
         0u, 1u, 1u, 0u},
        {"startup_idle", "Startup Idle", ParameterValueType::boolean, "boolean",
         0u, 1u, 1u, 1u},
        {"silence_timeout", "Silence Timeout",
         ParameterValueType::unsigned_integer, "ms", 0u, 60000u, 1u, 10000u},
        {"audio_confirmation", "Audio Confirmation",
         ParameterValueType::unsigned_integer, "ms", 0u, 60000u, 1u, 150u},
        {"idle_colour", "Idle Colour", ParameterValueType::colour, "RGBW", 0u,
         255u, 1u, 255u},
        {"idle_brightness", "Idle Brightness",
         ParameterValueType::unsigned_integer, "Q8", 0u, 256u, 1u, 256u},
        {"fade_to_effect", "Fade To Effects",
         ParameterValueType::unsigned_integer, "ms", 0u, 60000u, 1u, 750u},
        {"fade_to_idle", "Fade To Idle", ParameterValueType::unsigned_integer,
         "ms", 0u, 60000u, 1u, 1500u},
        {"activity_inputs", "Activity Inputs", ParameterValueType::bitmask,
         "mask", 0u, 7u, 1u, 7u},
        {"idle_strips", "Idle Strips", ParameterValueType::bitmask, "mask", 0u,
         63u, 1u, 63u},
        {"activity_floors", "Activity Floors",
         ParameterValueType::unsigned_integer, "raw ADC", 0u, 2047u, 1u, 32u},
        {"activity_hysteresis", "Activity Hysteresis",
         ParameterValueType::unsigned_integer, "raw ADC", 0u, 2047u, 1u, 4u},
    }};

constexpr std::array<EffectMetadata, 23> kMetadata{{
    {"off", "Off", EffectCategory::utility, kNoSource,
     effect_parameter_enabled},
    {"static_rgbw", "Static RGBW", EffectCategory::static_light, kNoSource,
     kBasic | effect_parameter_static_white_boost},
    {"linear_vu", "Linear VU", EffectCategory::vu, kLinearSources, kVu},
    {"stereo_center_out_vu", "Stereo Centre-Out VU", EffectCategory::vu,
     kStereoSource, kVu},
    {"spectrum_bars", "Spectrum Bars", EffectCategory::spectrum,
     kSpectrumSource, kSpectrum},
    {"mirrored_spectrum_zones", "Mirrored Spectrum Zones",
     EffectCategory::spectrum, kSpectrumSource, kSpectrum},
    {"macro_bands", "Macro Bands", EffectCategory::spectrum, kMacroSource,
     kSpectrum | effect_parameter_macro_mapping},
    {"one_band_frequency", "One-Band Frequency", EffectCategory::frequency,
     kMacroSource,
     kBasic | effect_parameter_source | effect_parameter_response |
         effect_parameter_frequency_selection},
    {"stroboscope", "Stroboscope", EffectCategory::ambient, kNoSource,
     kBasic | effect_parameter_strobe},
    {"ambient_color_cycle", "Ambient Colour Cycle", EffectCategory::ambient,
     kNoSource, kAmbientCycle},
    {"running_rainbow", "Running Rainbow", EffectCategory::ambient, kNoSource,
     kRunningRainbow},
    {"frequency_comet", "Frequency Comet", EffectCategory::frequency,
     kMacroSource,
     kBasic | effect_parameter_source | effect_parameter_direction |
         effect_parameter_animation | effect_parameter_frequency_selection |
         effect_parameter_comet},
    {"gyver_vu_gradient", "Gyver VU Gradient", EffectCategory::vu,
     kStereoSource, kGyverVuGradient},
    {"gyver_vu_rainbow", "Gyver VU Rainbow", EffectCategory::vu, kStereoSource,
     kGyverVuRainbow},
    {"gyver_frequency_5_zones", "Gyver Frequency 5 Zones",
     EffectCategory::frequency, kMacroSource, kGyverZones},
    {"gyver_frequency_3_zones", "Gyver Frequency 3 Zones",
     EffectCategory::frequency, kMacroSource, kGyverZones},
    {"gyver_frequency_full_strip", "Gyver Frequency Full Strip",
     EffectCategory::frequency, kMacroSource, kGyverFullStrip},
    {"gyver_stroboscope", "Gyver Stroboscope", EffectCategory::ambient,
     kNoSource, kBasic | effect_parameter_strobe},
    {"gyver_ambient_static", "Gyver Ambient Static", EffectCategory::ambient,
     kNoSource, kBasic | effect_parameter_static_white_boost},
    {"gyver_ambient_color_cycle", "Gyver Ambient Colour Cycle",
     EffectCategory::ambient, kNoSource, kAmbientCycle},
    {"gyver_ambient_running_rainbow", "Gyver Ambient Running Rainbow",
     EffectCategory::ambient, kNoSource, kRunningRainbow},
    {"gyver_running_frequencies", "Gyver Running Frequencies",
     EffectCategory::frequency, kMacroSource, kGyverRunningFrequencies},
    {"gyver_spectrum_analyzer", "Gyver Spectrum Analyzer",
     EffectCategory::spectrum, kSpectrumSource, kGyverSpectrum},
}};
...
uint8_t interpolate_channel(uint8_t idle, uint8_t effect, uint16_t mix) {
  return static_cast<uint8_t>((static_cast<uint32_t>(idle) * (65535u - mix) +
...
IdleLightingStatus
IdleLightingController::stage_config(const IdleLightingConfig &config) {
...
bool IdleLightingController::requires_runtime_reset(
    const IdleLightingConfig &active, const IdleLightingConfig &proposed) {
...
void IdleLightingController::cancel_pending_config() { pending_valid_ = false; }

const IdleLightingRuntime &IdleLightingController::runtime() const {
  return runtime_;
}

bool IdleLightingController::update_gate(uint16_t raw, uint16_t floor,
                                         uint16_t hysteresis, bool &active) {
  const uint16_t close = floor > hysteresis ? floor - hysteresis : 0u;
  active = active ? raw > close : raw > floor;
  return active;
}

uint16_t IdleLightingController::ramp(uint16_t current, uint16_t target,
  ...
  const uint32_t delta = std::min<uint32_t>(
      65535u, (static_cast<uint64_t>(elapsed_ms) * 65535u + duration_ms - 1u) /
                  duration_ms);
  if (target > current) {
...
RgbwColor IdleLightingController::scale(RgbwColor color, uint16_t level) {
  return {scale_channel(color.red, level), scale_channel(color.green, level),
          scale_channel(color.blue, level), scale_channel(color.white, level)};
}

RgbwColor IdleLightingController::interpolate(RgbwColor idle, RgbwColor effect,
                                              uint16_t mix) {
...
void IdleLightingController::update(const AudioLevelFrame &audio,
  ...
  if (!runtime_.initialized) {
    ...
    runtime_.effect_mix =
        runtime_.state == IdleLightingState::idle ? 0u : 65535u;
  ...
  update_gate(audio.left_peak, active_.left_activity_floor,
              active_.activity_hysteresis, runtime_.left_active);
  update_gate(audio.right_peak, active_.right_activity_floor,
              active_.activity_hysteresis, runtime_.right_active);
  update_gate(audio.aux_peak, active_.aux_activity_floor,
              active_.activity_hysteresis, runtime_.aux_active);

  const bool selected_active =
      ((active_.activity_input_mask & kIdleActivityLeft) != 0u &&
       runtime_.left_active) ||
      ((active_.activity_input_mask & kIdleActivityRight) != 0u &&
       runtime_.right_active) ||
      ((active_.activity_input_mask & kIdleActivityAux) != 0u &&
       runtime_.aux_active);
  ...
  if (selected_active) {
    ...
    effects_target =
        timestamp_us - runtime_.active_since_us >=
  ...
  const bool idle_target =
      !selected_active && runtime_.inactive_ms >= active_.silence_timeout_ms;
  if (effects_target) {
    runtime_.effect_mix = ramp(runtime_.effect_mix, 65535u,
                               active_.fade_to_effect_ms, elapsed_ms);
    runtime_.state = runtime_.effect_mix == 65535u
                         ? IdleLightingState::effects
                         : IdleLightingState::fading_to_effects;
  } else if (idle_target) {
    runtime_.effect_mix =
        ramp(runtime_.effect_mix, 0u, active_.fade_to_idle_ms, elapsed_ms);
...
void IdleLightingController::blend(
  ...
  const uint16_t brightness = static_cast<uint16_t>(std::min<uint32_t>(
      65535u, (static_cast<uint32_t>(active_.idle_brightness_q8) * 65535u +
               kEffectUnityGain / 2u) /
                  kEffectUnityGain));
  ...
  for (std::size_t strip = 0u; strip < spans.size(); ++strip) {
    ...
    for (std::size_t pixel = 0u; pixel < spans[strip].pixel_count; ++pixel) {
      spans[strip].pixels[pixel] =
          interpolate(idle, spans[strip].pixels[pixel], runtime_.effect_mix);
    }
  }
}
...
effect_parameter_descriptor(EffectParameterMask parameter) {
  ...
  return index < kParameterDescriptors.size() ? &kParameterDescriptors[index]
                                              : nullptr;
}
...
const ParameterDescriptor *idle_parameter_descriptor(std::size_t index) {
  return index < kIdleParameterDescriptors.size()
             ? &kIdleParameterDescriptors[index]
             : nullptr;
}
