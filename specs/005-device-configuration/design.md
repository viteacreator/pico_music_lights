...
- Existing runtime adapters in the LED, effects, Idle Lighting, audio, and startup layers consume only validated schema-owned configurations through explicit integration functions that convert to runtime types.
